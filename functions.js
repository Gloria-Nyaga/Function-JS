...
function countries (){
    let arr1 = ["Burundi", "Malawi", "Zambia", "Tanzania", "Uganda"];
...
let employeDetails = [
    { id: 8 },
    { name: "Gloria" },
    { salary: [50000, 30000, 80000, 5000] },
  ];
  employeDetails.sort(function(x, y) {
    return x.salary - (y.salary);
  });
  employeDetails.forEach((person) => console.log(employeDetails.salary));
